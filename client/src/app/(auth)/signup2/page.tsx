...
export default function Signup2() {
  ...
  return (
    ...
    >
      <div
        className="w-full bg-no-repeat bg-cover bg-top h-[280px] p-12 sm:p-4 drop-shadow-lg sm:max-w-[500px] sm:h-[720px] z-[100] flex flex-col justify-center items-center relative"
      ...
      <div className="w-full bg-white h-fit drop-shadow-2xl pb-7 sm:h-[720px] sm:max-w-[500px]">
        ...
        <form autoComplete="off" action="" className="flex flex-col px-3 space-y-5 ">
          ...
          <button className="w-full bg-gray-500 text-white font-bold text-2xl py-3 rounded-lg flex justify-center gap-5 items-center drop-shadow-md">
